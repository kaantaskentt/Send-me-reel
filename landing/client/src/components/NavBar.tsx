/*
 * NavBar — ContextDrop "Warm Signal" Design
 * Light background, orange CTA, clean minimal nav
 * Sticky with subtle border on scroll
 * Links: How it works | Pricing | Sign in → Dashboard CTA
 */
...
export default function NavBar() {
  ...
  // Treat /dashboard as "logged in" for nav display purposes
  const isInApp = location === "/dashboard" || location === "/chat";
