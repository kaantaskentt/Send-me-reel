...
/*
 * FinalCTASection + Footer — Manus "Merged Best" port (Apr 26)
 * Video bg bookend with amber overlay + trust signals + footer.
 */
...
export default function FinalCTASection() {
  const ctaRef = useScrollAnimation(0.2) as RefObject<HTMLDivElement>;
    ...
    <>
      ...
      >
        ...
        <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
          ...
          <div style={{ position: "absolute", inset: 0, background: "rgba(250,248,245,0.88)" }} />
        </div>

        <div className="cd-container" style={{ position: "relative", zIndex: 1 }}>
          <div ref={ctaRef} className="cd-fade-up max-w-2xl mx-auto text-center">
            <div
            ...
            >
              Your first 50 analyses are free. No credit card. No signup. Just send a link and see what happens.
            </p>
            ...
            <a
              ...
              className="cd-btn-primary cd-pulse-orange text-base !py-4 !px-8 inline-flex"
            >
            ...
            <div className="flex flex-wrap items-center justify-center gap-5 mt-8">
              {[
                { emoji: "✅", text: "50 free analyses" },
                { emoji: "🔒", text: "No account needed" },
                { emoji: "⚡", text: "30-second verdicts" },
            ...
            <div className="mt-6">
              <a
                href="/dashboard"
                className="text-slate-400 text-sm hover:text-slate-600 transition-colors cd-animated-link"
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              >
