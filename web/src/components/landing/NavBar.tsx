    ...
    >
      <div className="container flex items-center justify-between h-16">
        ...
        <div className="flex items-center gap-3">
          {!isInApp && (
            <Link href="/login" className="hidden sm:inline-flex text-sm text-slate-500 hover:text-slate-800 transition-colors" style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500 }}>
              Sign in
            </Link>
          )}
          {isInApp ? (
