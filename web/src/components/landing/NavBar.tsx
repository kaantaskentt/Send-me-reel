        ...
        <div className="flex items-center gap-3">
          ...
          {isInApp ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="https://wa.me/15551775759" target="_blank" rel="noopener noreferrer" className="!py-2 !px-4 !text-sm inline-flex items-center gap-1.5 rounded-full font-semibold text-white transition-all" style={{ background: "#25D366", fontSize: 14 }}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
