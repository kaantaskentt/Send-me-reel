...
/*
 * ProblemSection — Manus "Feel Seen First" port (Apr 26)
 * Pain moment cards + recognition payoff with who-it's-for grid.
 */
...
const PAIN_MOMENTS = [
  ...
  },
  {
    ...
    icon: "🔍",
    quote:
      "You watched a 90-second breakdown of an AI tool. It sounded perfect. You can't remember the name.",
...
export default function ProblemSection() {
  ...
  const painRef = useScrollAnimation(0.1) as RefObject<HTMLDivElement>;
  const whoRef = useScrollAnimation(0.15) as RefObject<HTMLDivElement>;

  return (
    <section className="py-24 lg:py-36" style={{ background: "#FAFAF8" }}>
      <div className="cd-container max-w-5xl mx-auto">
        {/* Headline */}
        <div ref={headlineRef} className="cd-fade-up text-center mb-16">
          <span
        ...
        <div
          ref={painRef}
          className="cd-stagger-children grid grid-cols-1 sm:grid-cols-2 gap-4 mb-20"
        >
        ...
        <div
          ref={whoRef}
          className="cd-fade-up rounded-3xl px-8 py-10 sm:px-12 sm:py-12 text-center"
          style={{
