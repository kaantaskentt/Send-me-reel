...
/*
 * VerdictSection — Manus "Warm Signal" port (Apr 26)
 * Animated chat mockup: link sent → typing → verdict slides in → action buttons.
 */
...
export default function VerdictSection() {
  ...
  return (
    <section id="verdict" className="py-24 lg:py-32" style={{ background: "white" }}>
      <div className="cd-container">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            >
              ...
              <div className="p-4 space-y-3" style={{ minHeight: 320 }}>
                ...
                >
                  ...
                  >
                    <p
                      className="text-white text-xs break-all leading-relaxed"
                      style={{ fontFamily: "'DM Sans', sans-serif" }}
                    >
                    ...
                    >
                      {[0, 150, 300].map((delay) => (
                        <span
                          ...
                          style={{ animation: `cd-typingBounce 1s ${delay}ms infinite` }}
                        />
                      ))}
                    </div>
                  </div>
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className="text-[#1a1a1a] text-sm font-bold mb-3 leading-snug"
                      style={{ fontFamily: "'DM Sans', sans-serif" }}
                    >
                    ...
                    >
                      <button className="cd-verdict-btn-learn">📚 Learn</button>
                      <button className="cd-verdict-btn-apply">🚀 Apply</button>
                      <button className="cd-verdict-btn-skip">⏭ Skip</button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* Right: copy */}
          <div ref={headlineRef} className="cd-fade-up flex-1 min-w-0">
            <span className="cd-section-label block mb-3">Example Verdict</span>
            <h2
