    ...
    <div className="flex h-full" style={{ background: "white" }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <div className="flex-1 overflow-y-auto p-2.5 flex flex-col gap-2">
          ...
          <div className="rounded-xl p-3" style={{ background: "white", border: "1px solid #f0ece6" }}><div className="flex items-center gap-2 mb-1.5"><XIcon /><span className="text-xs font-semibold tracking-wide" style={{ color: "#9ca3af" }}>X / TWITTER</span></div><div className="font-bold text-xs mb-1 leading-snug" style={{ color: "#1a1a1a" }}>The Cursor AI workflow that 10x&apos;d my output</div><div className="text-xs mb-1.5 leading-relaxed" style={{ color: "#6b7280", fontStyle: "italic" }}>Tab completion + inline chat = 3x faster reviews.</div><div className="flex gap-1">{["cursor", "workflow"].map(t => <span key={t} className="text-xs px-2 py-0.5 rounded-full" style={{ background: "#f5f5f5", color: "#6b7280" }}>{t}</span>)}</div></div>
