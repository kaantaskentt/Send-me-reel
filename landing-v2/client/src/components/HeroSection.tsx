/*
 * HeroSection — ContextDrop Overhaul
 * New messaging: "Turn content into action" — no Learn/Apply/Skip, no verdicts
 * Core action: Add to tasks. Core value: your feed becomes your to-do list.
 */
...
const DASHBOARD_MOCKUP =
  "https://d2xsxph8kpxj0f.cloudfront.net/310419663029819932/PLcAoykFsSXnZwd5KnAU3Y/dashboard-mockup-QkXCrWaVsHLm5QrPdsP3PU.webp";
    ...
    >
      ...
      <div
        style={{
          ...
          maxWidth: 860,
          margin: "0 auto",
          padding: "0 clamp(1rem, 4vw, 2.5rem) clamp(3rem, 6vh, 5rem)",
          ...fade(0.5),
        }}
      >
        <div
        ...
        >
          ...
          <div style={{ flex: "1 1 0", minWidth: "clamp(240px, 44vw, 380px)", maxWidth: 400, display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            <div style={{ background: "white", borderRadius: 14, border: "1px solid #e7e2d9", padding: "13px 15px", boxShadow: "0 8px 28px rgba(0,0,0,0.08), 0 2px 6px rgba(0,0,0,0.04)" }}>
              ...
              <div style={{ fontSize: 10.5, color: "#57534e", lineHeight: 1.55, fontStyle: "italic", marginBottom: 8, fontFamily: "'DM Sans', sans-serif" }}>This is the one. Orchestrator pattern cuts prompt complexity in half. The GitHub repo he flashes at 2:14 is the real takeaway — fork it before you do anything else. The rest of the reel is just context.</div>
            ...
            <div style={{ background: "white", borderRadius: 14, border: "1px solid #e7e2d9", padding: "13px 15px", boxShadow: "0 4px 14px rgba(0,0,0,0.05)" }}>
              ...
              <div style={{ fontSize: 10.5, color: "#57534e", lineHeight: 1.55, fontStyle: "italic", marginBottom: 8, fontFamily: "'DM Sans', sans-serif" }}>Mid. He's rehashing a blog post from 2024. The one stat about anchoring is worth 30 seconds of your time. Skip the rest — you've seen this before.</div>
              <div style={{ display: "flex", gap: 4, flexWrap: "wrap", marginBottom: 8 }}>
                {["saas", "pricing"].map(t => <span key={t} style={{ fontSize: 9, color: "#78716c", background: "#f5f3f0", border: "1px solid #e7e2d9", borderRadius: 20, padding: "2px 7px", fontFamily: "'DM Sans', sans-serif" }}>{t}</span>)}
              </div>
              <div style={{ display: "flex", gap: 5 }}>
                <div style={{ background: "#f0fdf4", border: "1px solid #bbf7d0", color: "#16a34a", fontSize: 9, fontWeight: 700, padding: "4px 9px", borderRadius: 5, fontFamily: "'DM Sans', sans-serif" }}>✅ Add to tasks</div>
                <div style={{ background: "#fff7ed", border: "1px solid #fed7aa", color: "#ea580c", fontSize: 9, fontWeight: 700, padding: "4px 9px", borderRadius: 5, fontFamily: "'DM Sans', sans-serif" }}>⚡ Deep Dive</div>
              </div>
            </div>
            ...
            <div style={{ background: "white", borderRadius: 14, border: "1px solid #e7e2d9", padding: "13px 15px", boxShadow: "0 4px 14px rgba(0,0,0,0.05)" }}>
              ...
              <div style={{ fontSize: 10.5, color: "#57534e", lineHeight: 1.55, fontStyle: "italic", marginBottom: 8, fontFamily: "'DM Sans', sans-serif" }}>Solid. Tab completion + inline chat = 3x faster code reviews. This is your lane — the workflow maps directly to what you're building. Try it on the next PR before committing to the full setup.</div>
              <div style={{ display: "flex", gap: 4, flexWrap: "wrap", marginBottom: 8 }}>
                {["cursor", "workflow"].map(t => <span key={t} style={{ fontSize: 9, color: "#78716c", background: "#f5f3f0", border: "1px solid #e7e2d9", borderRadius: 20, padding: "2px 7px", fontFamily: "'DM Sans', sans-serif" }}>{t}</span>)}
              </div>
              <div style={{ display: "flex", gap: 5 }}>
                <div style={{ background: "#f0fdf4", border: "1px solid #bbf7d0", color: "#16a34a", fontSize: 9, fontWeight: 700, padding: "4px 9px", borderRadius: 5, fontFamily: "'DM Sans', sans-serif" }}>✅ Added to tasks</div>
                <div style={{ background: "#fff7ed", border: "1px solid #fed7aa", color: "#ea580c", fontSize: 9, fontWeight: 700, padding: "4px 9px", borderRadius: 5, fontFamily: "'DM Sans', sans-serif" }}>⚡ Deep Dive</div>
