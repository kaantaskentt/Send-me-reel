/*
 * DashboardPreviewSection — ContextDrop Overhaul
 * Shows the new dashboard mockup image with feature callouts.
 * No personal names. No Learn/Apply/Skip. Core features: Feed, Tasks, Ask AI, Connectors.
 */
...
const FEATURES = [
  {
    emoji: "📥",
    title: "Your Feed",
    desc: "Every link you've sent, summarised and organised. Filter by platform, search by keyword, expand any card for the full breakdown.",
  },
  {
    emoji: "✅",
    title: "Tasks",
    desc: "Add any insight to your task list with one tap. Each task stays linked to the content it came from so you never lose context.",
  },
  {
    emoji: "💬",
    title: "Ask AI",
    desc: "Ask follow-up questions about any piece of content. Get a step-by-step plan, alternatives, or a deeper breakdown — all in context.",
  },
  {
    emoji: "🔗",
    title: "Connectors",
    desc: "Sync to Notion, Todoist, and Google Calendar (coming soon). Your summaries and tasks flow into the tools you already use.",
  },
];
      ...
      >
        ...
        >
          ...
          >
            ...
            <br />
            <span style={{ color: "#f97316" }}>Finally actionable.</span>
          </h2>
          <p
            style={{
              fontSize: 15,
        ...
        <div
          ref={mockupRef}
          className="fade-up dashboard-mockup-wrap"
        ...
        >
          <div
            style={{
              ...
              overflow: "hidden",
              boxShadow:
                "0 32px 80px rgba(0,0,0,0.14), 0 8px 24px rgba(0,0,0,0.07), 0 0 0 1px rgba(0,0,0,0.06)",
          ...
          >
            ...
            >
              ...
              >
                app.contextdrop.com/dashboard
              </div>
            </div>

            {/* Dashboard content — inline mini mockup */}
            <div style={{ background: "#faf8f5", display: "flex", minHeight: 420 }}>
              ...
              >
                ...
                <div style={{ padding: "0 16px 12px", borderBottom: "1px solid #f0ede8", marginBottom: 12 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 9, color: "#a8a29e", fontFamily: "'DM Sans', sans-serif" }}>@alexm</div>
                    </div>
                  </div>
                </div>
                ...
                {[
                  ...
                  { emoji: "✅", label: "Tasks", active: false, badge: "4" },
                  { emoji: "💬", label: "Ask AI", active: false, badge: "New" },
                  ...
                  >
                    ...
                    <span style={{ fontSize: 11.5, fontWeight: item.active ? 700 : 500, color: item.active ? "#f97316" : "#57534e", fontFamily: "'DM Sans', sans-serif", flex: 1 }}>
                      {item.label}
                    </span>
                    {item.badge && (
                      <span style={{ fontSize: 9, fontWeight: 700, background: item.badge === "New" ? "#f97316" : "#fff7ed", color: item.badge === "New" ? "white" : "#f97316", padding: "1px 5px", borderRadius: 20 }}>
                        {item.badge}
                      </span>
                    )}
                  </div>
                ...
                <div style={{ margin: "12px 16px 0", padding: "10px 12px", background: "#faf8f5", borderRadius: 8, border: "1px solid #f0ede8" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                    <span style={{ fontSize: 9, color: "#a8a29e", fontFamily: "'DM Sans', sans-serif" }}>Monthly credits</span>
                    <span style={{ fontSize: 9, fontWeight: 700, color: "#f97316", fontFamily: "'DM Sans', sans-serif" }}>47/100</span>
                  </div>
              ...
              {/* Main feed */}
              <div style={{ flex: 1, padding: "16px", overflow: "hidden", minWidth: 0 }}>
                {/* Filter tabs */}
                <div style={{ display: "flex", gap: 6, marginBottom: 12, flexWrap: "wrap", overflow: "hidden" }}>
                  {["All", "Instagram", "TikTok", "X"].map((tab, i) => (
                    <div
                      ...
                      style={{
                        ...
                        border: `1px solid ${i === 0 ? "#f97316" : "#e7e2d9"}`,
                        fontFamily: "'DM Sans', sans-serif",
                        cursor: "pointer",
                      }}
                    >
                ...
                {[
                  {
                    platform: "youtube",
                    title: "Claude Code: sub-agents that actually ship",
                    summary: "Orchestrator runs the others. CLAUDE.md at 14:30 is the only part worth rewinding.",
                    expanded: true,
                    color: "#dc2626",
                    time: "4m ago",
                  },
                  {
                    ...
                    summary: "Tab completion + inline chat = 3x faster reviews. Try it on the next PR.",
                    expanded: false,
                    color: "#000",
                    time: "1h ago",
                  },
                  {
                    ...
                    summary: "Mid. The one stat about anchoring is worth 30 seconds. Skip the rest.",
                    expanded: false,
                    color: "#0077b5",
                    time: "3h ago",
                  },
                  ...
                  <div
                    ...
                    style={{
                      background: "white",
                      borderRadius: 10,
                      border: `1px solid ${card.expanded ? "#e7e5e4" : "#f0ede8"}`,
                      marginBottom: 8,
                      overflow: "hidden",
                      boxShadow: card.expanded ? "0 4px 16px rgba(0,0,0,0.07)" : "0 1px 3px rgba(0,0,0,0.04)",
                    }}
                  >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        {!card.expanded && (
                          <div style={{ display: "flex", gap: 6, marginTop: 4 }}>
                            <span style={{ fontSize: 8, color: "#d4cfc9" }}>⚡ Deep Dive</span>
                            <span style={{ fontSize: 8, color: "#d4cfc9" }}>· 💬 Ask</span>
                          </div>
                        )}
                      </div>
                    ...
                    {card.expanded && (
                      <div style={{ padding: "0 12px 12px", borderTop: "1px solid #f5f3f0" }}>
                        ...
                        <div style={{ display: "flex", gap: 6, marginBottom: 8 }}>
                          <div style={{ background: "#f0fdf4", border: "1px solid #bbf7d0", color: "#16a34a", fontSize: 9, fontWeight: 700, padding: "5px 10px", borderRadius: 6 }}>
                            ✅ Add to my tasks
                          </div>
                          <div style={{ background: "#f5f3ff", border: "1px solid #ddd6fe", color: "#7c3aed", fontSize: 9, fontWeight: 700, padding: "5px 10px", borderRadius: 6 }}>
                            ⚡ Deep Dive
                          </div>
                        </div>
                        {/* Task item */}
