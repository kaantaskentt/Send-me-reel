...
const CONNECTORS = [
  ...
  },
  {
    ...
    description: "Schedule tasks from content",
    connected: false,
    comingSoon: true,
    icon: (
              ...
              {CONNECTORS.map(c => (
                ...
                >
                  ...
                  {c.connected ? (
                    ...
                    <span className="text-[9px] font-700 text-stone-400 bg-stone-100 px-2 py-0.5 rounded-full">
                      Soon
                    </span>
                  ) : (
      ...
      <nav className="flex flex-col gap-0.5 mb-3">
        ...
        <Link href="/chat">
          <button className="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-500 text-stone-500 hover:bg-stone-50 hover:text-stone-700 transition-all w-full text-left">
            ...
            <span className="text-[9px] font-700 bg-orange-100 text-orange-500 px-1.5 py-0.5 rounded-full uppercase tracking-wide">New</span>
          </button>
        </Link>
      </nav>
