 ...
 * (Wikipedia "Signs of AI writing" patterns).
 *
 * Inject into every system prompt that produces user-facing text. The rules
 * are written DENSE on purpose — every line is a separate constraint the
 * model checks against. Don't soften them.
 *
